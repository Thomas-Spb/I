		 ...
		 <div className={s.container}>
			...
			<div className={s.development}>
				<ul className={s.developmentList}>
					<li className={s.developmentItem}>Designer: 
					<a className={s.link} href="#"> Иван Морозов</a></li>
					<li className={s.developmentItem}>Developer: 
					<a className={s.link} href="#"> Thomas</a></li>
				</ul>
			</div>
		 </div>
		</Container>
